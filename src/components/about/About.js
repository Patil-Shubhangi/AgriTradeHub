...
const About = () => {
    return ( <
        ...
        <
        Heading title = 'AgriTradeHub'
        subtitle = 'AgriConnect: Where Trade Blossoms' / >
        <
        p > Welcome to AgriTradeHub, your gateway to a world of agricultural trade opportunities.Our platform brings together farmers, producers, buyers, and sellers from across the globe, fostering connections that cultivate success. < /p> <
        p > Whether you 're seeking to expand your market reach, source high-quality products, or optimize your supply chain, AgriTradeHub is here to empower you with seamless transactions, valuable insights, and unparalleled networking. Join us in redefining the future of agritrade, where growth knows no bounds.</p> <
        button className = 'btn2' > More About Us < /button> <
        /div> <
        div className = 'right row' >
        <
        img src = 'https://live.staticflickr.com/1060/4611303097_e1305d6cd2_b.jpg'
        alt = '' / >
        <
        /div> <
        /div> <
        ...
        >
        <
        TeamMember name = "Buyers"
        role = "Buying the Product"
